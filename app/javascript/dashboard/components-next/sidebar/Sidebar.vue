...
// В апстриме блок Captain добавляется в сайдбар безусловно: при выключенной
// фиче пункт всё равно виден, а по клику открывается страница с предложением
// купить тариф. Нам платный Captain не нужен, поэтому прячем пункт целиком —
// тем же способом, что уже применён к Calls ниже.
